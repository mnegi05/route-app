...
class MainComponent extends Component {
    ...
    render() {
        const { employees, offices } = this.state;
        return <>
            <div>
                <NavBar />
                <Switch>
                    <Route path='/employees' render={(props) => <Employees {...props} employees={employees} />} />
                    <Route path='/offices/:name' render={(props) => <Offices {...props} offices={offices} />} />
                    <Route path='/offices' render={(props) => <Offices {...props} offices={offices} />} />
